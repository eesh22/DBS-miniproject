 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/logofinal.png" alt=""  /></a>
            </div>
         ...
         <div id="testimonials-sec" class="container set-pad" >
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     ...
                     Have a look what our customers said about us.
                         </p>
                 </div>
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/person-1.avif" style="width:100px;height:100px;" />
                   <h3 >Sushant Kapoor</h3>
                 <hr />
                       <hr />
                   <p >
               ...
               <a class="btn btn-info btn-set"  >SLS 2020 Munich Champion</a>
                </div>
                   </div>
                 ...
                 <hr />
                       <hr />
                   <p >
                       Once I had mistakenly ordered a wrong set up but luckily they immediately notified me.
                   </p>
				   </center>
				   <br />
               ...
               <a class="btn btn-info btn-set"  >2022 SLS Women Division Champion</a>
                </div>
                   </div>
                 
				 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/person-4.avif" style="width:100px;height:100px;" />
                   <h3 >Lin<br />Shiem</h3>
                 <hr />
                       <hr />
    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.4s">
                   ...
                   <h3 >EESHAN UPADHYAYA</h3>
                 <hr />
                         <h4>MIT<br />CS AIML Department</h4>
                   <p >
                       Eeshan Upadhyaya is the designer and developer of this site. 
					   He is currently pursuing B.Tech at Manipal Institute of Technology, Manipal.   
					   He is specialized in Web Development.
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        <h4><strong>Call:</strong> +91 9999900099</h4>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2023 EDGE Skateshop| All Rights Reserved |  <a style="color: #fff" target="_blank">Designed by : Eeshan</a>
    </div>
     <!-- FOOTER SECTION END-->
